...
namespace rx_packet_64_frame_test
{
    ...
    {
        return rx_packet_64_frame(
            any_source_address, any_rssi, any_options, std::vector<uint8_t>());
    }
    ...
    {
        ASSERT_EQ(1, rx_packet_64_frame::SOURCE_ADDRESS_OFFSET);
        ASSERT_EQ(9, rx_packet_64_frame::RSSI_OFFSET);
        ASSERT_EQ(10, rx_packet_64_frame::OPTIONS_OFFSET);
        ASSERT_EQ(11, rx_packet_64_frame::RF_DATA_OFFSET);
    ...
    TEST(RXPacket64FrameTest, IsBroadcastFrameTest)
    {
        ...
        rx_packet_64_frame frame1(
            any_source_address, any_rssi, address_broadcast, any_valid_payload);
