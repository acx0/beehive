...
{
    return source_address == rhs.source_address && source_port == rhs.source_port && destination_address == rhs.destination_address && destination_port == rhs.destination_port;
}
